...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, { style: { alignItems: 'center' } },
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$P, { width: "24px", color: "primary" })) : (React.createElement(Icon$O, { width: "24px", color: "primary" }))),
